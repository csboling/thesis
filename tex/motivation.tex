...
\cite{10.1371/journal.pmed.0020124}. Ideally, a unit of disseminated
...
pipelines have begun to emerge in recent years \cite{Taverna,
  VisTrails} which offer support for a number of powerful features,
including data provenance, sharing and refining workflows, and
packaging execution environments into virtual machines for
later execution on different hardware.
 However, many modern scientific endeavors involve some mixture of
\textit{in-silico} analysis workflows and directly perturbing physical
systems, and software toolchains for uniformly managing procedures of
this nature remain immature. A tool suited for the challenges of
modern research should be (i) automatic, employing computer control
...
that meets all the above goals.
...
by discoverable web APIs. This architecture promotes modularity,
allowing researchers to extend the system to meet their needs, and
enables investigators to interact with each others' research
remotely. The framework provides high-level capabilities for
